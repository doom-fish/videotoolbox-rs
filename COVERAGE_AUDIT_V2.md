# videotoolbox-rs coverage audit v2 (vs MacOSX26.2.sdk)
...
Comprehensive audit of `videotoolbox-rs` against the macOS SDK headers. All 449 public VideoToolbox symbols were enumerated from the framework headers; 448 are verified as present in the crate's FFI bindings and/or safe wrappers, and 1 is exempt (deprecated misspelled alias). Coverage percentage: 100.00% of non-exempt symbols.
